...
st.set_page_config(
    page_title="11886 - Unsupervised Learning", 
    page_icon="",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - ALEXA</h1>", unsafe_allow_html=True) 
    st.dataframe(input_data)

    model_directory = r'D:\SEMESTER 5\ML\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)\Tugas4_B_11886'
    model_path = {
